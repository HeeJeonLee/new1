...
export default function InsuranceComparison() {
  ...
  const insuranceCompanies = [
    ...
    },
    {
      ...
      coverage: { medical: 6000000, surgery: 8000000, liability: 50000000, mriCt: 2500000 },
      specialFeatures: ['치과 특약 우수', '다견 10% 할인', '통합 앱 관리', '갱신 20세까지'],
      deductible: 10,
      waitingPeriod: 30,
      renewalLimit: 20,
      rating: 4,
    ...
    },
    {
      ...
      coverage: { medical: 7000000, surgery: 12000000, liability: 100000000, mriCt: 3500000 },
      specialFeatures: ['100% 보장 비율', '피부 질환 특약', '구강 질환 특약', '가성비 우수'],
      deductible: 10,
      waitingPeriod: 30,
      renewalLimit: 18,
      rating: 4,
    ...
    },
    {
      ...
      coverage: { medical: 8000000, surgery: 15000000, liability: 100000000, mriCt: 5000000 },
      specialFeatures: ['MRI/CT 한도 업계 상위', '고액 치료비 대비', '중증 질환 강화', '갱신 20세까지'],
      deductible: 20,
      waitingPeriod: 30,
      renewalLimit: 20,
      rating: 5,
    ...
    },
    {
      ...
      coverage: { medical: 7000000, surgery: 10000000, liability: 150000000, mriCt: 3500000, dentalOrtho: 2000000 },
      specialFeatures: ['2026년 신상품 출시', '보장 범위 대폭 확대', '치과 질환 신규 담보', '노령견 특화 담보', '갱신 18세까지 (확대)'],
      deductible: 10,
      waitingPeriod: 30,
      renewalLimit: 18,
      rating: 4,
    ...
    },
    {
      ...
      coverage: { medical: 6000000, surgery: 9000000, liability: 80000000, mriCt: 2800000 },
    ...
    },
    {
      ...
      coverage: { medical: 5500000, surgery: 8500000, liability: 150000000, mriCt: 2200000 },
      specialFeatures: ['배상책임 1.5억원', '장례비용 지원', '농협 조합원 할인', '갱신 16세까지'],
      deductible: 15,
      waitingPeriod: 30,
      renewalLimit: 16,
      rating: 3,
    ...
    },
    {
      ...
      coverage: { medical: 5000000, surgery: 7500000, liability: 80000000, mriCt: 2000000 },
      specialFeatures: ['기본적인 보장', '표준 약관'],
      deductible: 20,
      waitingPeriod: 30,
      renewalLimit: 15,
      rating: 2,
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium text-gray-900">월 보험료 ({filterAge})</td>
                  {compareCompanies.map(company => (
                    <td
                      key={company.id}
